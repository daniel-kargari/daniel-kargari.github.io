    ...
    <section id="experience" className="scroll-mt-16 lg:mt-16">
      ...
      <>
        {jobPositions.map((job, index) => (
          <Card
            key={index}
            className="job-position-container lg:p-6 mb-8 flex flex-col lg:flex-row w-full min-h-fit gap-0  border-transparent hover:border  dark:lg:hover:bg-slate-800/50 lg:hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:hover:drop-shadow-lg lg:hover:bg-slate-100/50 "
          >
